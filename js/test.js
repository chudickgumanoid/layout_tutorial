...
if (count == 100) {
   document.write("<div style='width:60%; height: auto; margin:auto; margin-top:250px; padding:20px; text-align:center; border-radius: 5px; background-color:#fff;color:#000; height:auto; font-size:30pt;'>Отлично, ты делаешь успехи)      <br><br>     "+count+"%<br><br><a style='color:#000;' href='test-html-obout.html'>Следующий тест</a></div>");
}
else{
   document.write("<div style='width:60%; height: auto; margin:auto; margin-top:250px; padding:20px; text-align:center; border-radius: 5px; background-color:#fff; color:#000; height:auto; font-size:30pt;'>Попробуй в следующий раз)     <br><br>     "+count+"%<br><br><a style='color:#000;' href='test-html-obout.html'>Вернутся назад</a></div>");
}
}